...
class SearchCallFactory {
  ...
  <V> HttpCall<V> newCall(SearchRequest request, HttpCall.BodyConverter<V> bodyConverter) {
  ...
  HttpUrl lenientSearch(List<String> indices, String type) {
  ...
  static String join(char delim, List<String> parts) {
